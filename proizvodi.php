			...
			<nav>
				<ul class="linkovi">
					...
					<li class="has-children">
						<a class="active" href="proizvodi.php"><i class="fas fa-tools"></i> Proizvodi</a>
						<ul class="dropdown">
            ...
            <div class="grid-container">
                ...
                <div class="grid-item">
                    <div class="card">
                        ...
                        <h1 style="font-size: 20px;">Apple iPhone 12</h1>
                ...
                <div class="grid-item">
                    <div class="card">
                        ...
                        <p style="font-size: 16px;"">Xiaomi 11T Pro 5G Dual SIM 256GB 8GB RAM Sivi</p>
